...
class HeaderSortComponent extends Component {
  ...
  render() {
    return (
        ...
        <li><a href="#" key={1} className={this.state.activeItem === 1 ? 'activetxt': ''} onClick={ () => {this.handleItemClick(1);this.props.onSortApply('{"field":"price","sort":"desc"}')} }>Price -- High Low</a></li>
        <li><a href="#" key={2} className={this.state.activeItem === 2 ? 'activetxt': ''} onClick={ () => {this.handleItemClick(2);this.props.onSortApply('{"field":"price","sort":"asc"}') }}>Price -- Low High</a></li>
